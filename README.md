...
- **Docker** : To install all the necessary libraries

### Dépendances

| Dépendance | Version | Rôle |
|-----------|---------|------|
| **OpenGL** | 4.6+ | Rendu graphique |
| **OpenCL** | 1.2+ | Calcul GPU parallèle |
| **GLFW** | 3.3 | Gestion fenêtre/input |
...
```bash
./Particule_system <nombre_de_particules> <forme_initiale>  # sphere or cube only
```
